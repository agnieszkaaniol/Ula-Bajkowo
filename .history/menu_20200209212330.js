...
window.onload = () => {
  ...
  langHover1 = document.querySelectogetElementById('lang-hov-1');
  langHover2 = document.querySelectogetElementById('lang-hov-2');
  ...
  langHover1.addEventListener('mouseover', (event) => {
    let target = event.target;
  ...
  langHover2.addEventListener('mouseover', (event) => {
    let target = event.target;
    event.target.style.color = "white";
    setTimeout(function() {
      event.target.style.color = "";
