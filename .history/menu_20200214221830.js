...
window.onload = () => {
    ...
    window.addEventListener('scroll', (e) => {
        const text = document.querySelectorAll('.main-title')[0],
            heroPic = document.querySelector('.main-angel');
        ...
        heroPic.style.top = heroPic.getBoundingClientRect().top + ratePic + 'px';
        console.log('%c heroPic.getBoundingClientRect().top + ratePic:', 'background: #ffcc00; color: #003300', heroPic.getBoundingClientRect().top + ratePic)
        text.style.top = text.getBoundingClientRect().top+ rateText + 'px';
        console.log('%c text.getBoundingClientRect().top+ rateText:', 'background: #ffcc00; color: #003300', text.getBoundingClientRect().top+ rateText)
