...
window.onload = () => {
  ...
  const menu = document.querySelectorAll('.navv')[0],
      ...
      heroPic = document.querySelectorAll('.main-angel')[0];
      mountainsPic = document.querySelectorAll('.main-mountains')[0];

  var imgHeight = document.querySelector('.main-background').getBoundingClientRect().height,
      imgWidth = document.querySelector('.main-background').getBoundingClientRect().width, //zmiana na mountains
      menuFixed = false;
