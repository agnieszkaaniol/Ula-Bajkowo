...
window.onload = () => {
  ...
  var imgWidth = document.querySelector('.main-background').getBoundingClientRect().width;
      ...
      function changeSrc(imgWidth) {
        if (imgWidth < 769) {
          document.getElementsById("main-mountains").src = "img/BGMobilez.png";
          document.getElementsById("main-angel").src = "img/HeroMobilez.png";
        } else {
          document.getElementsById("main-mountains-desktop").src = "img/mainBg.png";
          document.getElementsById("main-angel-desktop").src = "img/AngelHeroNew.png";
        };
      }
