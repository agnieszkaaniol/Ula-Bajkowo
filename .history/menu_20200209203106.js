...
window.onload = () => {
  ...
  var langHover = document.getElementsByClassName('languages');

  function myHover() {
    langHover.style.color = 'var(--color_back)';
    langHover.style.transform = 'scale(1.5)';
    langHover.style.[-webkit-transform] = 'scale(1.5)';
    langHover.style.[-ms-transform] = 'scale(1.5)';
  }
